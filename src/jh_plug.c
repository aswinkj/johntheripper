...
static HashReturn Update(hashState *state, const BitSequenceJH *data, DataLengthJH databitlen);
static HashReturn Final(hashState *state, BitSequenceJH *hashval);
...
static HashReturn Update(hashState *state, const BitSequenceJH *data, DataLengthJH databitlen)
{
      DataLengthJH index; /*the starting address of the data to be compressed*/
